...
from biblemark.model.bible_version_book_structure import BibleVersionBookStructure


class BibleVersionStructure:

    def __init__(self, mappings: {}):
        self.mappings = mappings

    def get(self, book: BibleBook) -> Optional[BibleVersionBookStructure]:
        if book.get_id() in self.mappings:
            return self.mappings[book.get_id()]
        else:
            return None


COMMON_PROTESTANT_STRUCTURE = BibleVersionStructure({
    BibleBook.GENESIS.get_id(): BibleVersionBookStructure(BibleBook.GENESIS, 1, 50, {
    ...
    BibleBook.EXODUS.get_id(): BibleVersionBookStructure(BibleBook.EXODUS, 2, 40, {
    ...
    BibleBook.LEVITICUS.get_id(): BibleVersionBookStructure(BibleBook.LEVITICUS, 3, 27, {
    ...
    BibleBook.NUMBERS.get_id(): BibleVersionBookStructure(BibleBook.NUMBERS, 4, 36, {
    ...
    BibleBook.DEUTERONOMY.get_id(): BibleVersionBookStructure(BibleBook.DEUTERONOMY, 5, 34, {
    ...
    BibleBook.JOSHUA.get_id(): BibleVersionBookStructure(BibleBook.JOSHUA, 6, 24, {
    ...
    BibleBook.JUDGES.get_id(): BibleVersionBookStructure(BibleBook.JUDGES, 7, 21, {
        "1": 36, "2": 23, "3": 31, "4": 24, "5": 31, "6": 40, "7": 25, "8": 35, "9": 57, "10": 18,
        "11": 40, "12": 15, "13": 25, "14": 20, "15": 20, "16": 31, "17": 13, "18": 31, "19": 30, "20": 48,
        "21": 25
    }),
    BibleBook.RUTH.get_id(): BibleVersionBookStructure(BibleBook.RUTH, 8, 4, {
        "1": 22, "2": 23, "3": 18, "4": 22
    }),
    BibleBook.FIRST_SAMUEL.get_id(): BibleVersionBookStructure(BibleBook.FIRST_SAMUEL, 9, 31, {
    ...
    BibleBook.SECOND_SAMUEL.get_id(): BibleVersionBookStructure(BibleBook.SECOND_SAMUEL, 10, 24, {
    ...
    BibleBook.FIRST_KINGS.get_id(): BibleVersionBookStructure(BibleBook.FIRST_KINGS, 11, 22, {
        "1": 53, "2": 46, "3": 28, "4": 34, "5": 18, "6": 38, "7": 51, "8": 66, "9": 28, "10": 29,
        "11": 43, "12": 33, "13": 34, "14": 31, "15": 34, "16": 34, "17": 24, "18": 46, "19": 21, "20": 43,
        "21": 29, "22": 53
    }),
    BibleBook.SECOND_KINGS.get_id(): BibleVersionBookStructure(BibleBook.SECOND_KINGS, 12, 25, {
    ...
    BibleBook.FIRST_CHRONICLES.get_id(): BibleVersionBookStructure(BibleBook.FIRST_CHRONICLES, 13, 29, {
        "1": 54, "2": 55, "3": 24, "4": 43, "5": 41, "6": 66, "7": 40, "8": 40, "9": 44, "10": 14,
        "11": 47, "12": 40, "13": 14, "14": 17, "15": 29, "16": 43, "17": 27, "18": 17, "19": 19, "20": 8,
        "21": 30, "22": 19, "23": 32, "24": 31, "25": 31, "26": 32, "27": 34, "28": 21, "29": 30
    }),
    BibleBook.SECOND_CHRONICLES.get_id(): BibleVersionBookStructure(BibleBook.SECOND_CHRONICLES, 14, 36, {
    ...
    BibleBook.EZRA.get_id(): BibleVersionBookStructure(BibleBook.EZRA, 15, 10, {
        "1": 11, "2": 70, "3": 13, "4": 24, "5": 17, "6": 22, "7": 28, "8": 36, "9": 15, "10": 44
    }),
    BibleBook.NEHEMIAH.get_id(): BibleVersionBookStructure(BibleBook.NEHEMIAH, 16, 13, {
        "1": 11, "2": 20, "3": 32, "4": 23, "5": 19, "6": 19, "7": 73, "8": 18, "9": 38, "10": 39,
        "11": 36, "12": 47, "13": 31
    }),
    BibleBook.ESTHER.get_id(): BibleVersionBookStructure(BibleBook.ESTHER, 17, 10, {
        "1": 22, "2": 23, "3": 15, "4": 17, "5": 14, "6": 14, "7": 10, "8": 17, "9": 32, "10": 3
    }),
    BibleBook.JOB.get_id(): BibleVersionBookStructure(BibleBook.JOB, 18, 42, {
    ...
    BibleBook.PSALMS.get_id(): BibleVersionBookStructure(BibleBook.PSALMS, 19, 150, {
    ...
    BibleBook.PROVERBS.get_id(): BibleVersionBookStructure(BibleBook.PROVERBS, 20, 31, {
    ...
    BibleBook.ECCLESIASTES.get_id(): BibleVersionBookStructure(BibleBook.ECCLESIASTES, 21, 12, {
        "1": 18, "2": 26, "3": 22, "4": 16, "5": 20, "6": 12, "7": 29, "8": 17, "9": 18, "10": 20,
        "11": 10, "12": 14
    }),
    BibleBook.SONG_OF_SONGS.get_id(): BibleVersionBookStructure(BibleBook.SONG_OF_SONGS, 22, 8, {
        "1": 17, "2": 17, "3": 11, "4": 16, "5": 16, "6": 13, "7": 13, "8": 14
    }),
    BibleBook.ISAIAH.get_id(): BibleVersionBookStructure(BibleBook.ISAIAH, 23, 66, {
    ...
    BibleBook.JEREMIAH.get_id(): BibleVersionBookStructure(BibleBook.JEREMIAH, 24, 52, {
    ...
    BibleBook.LAMENTATIONS.get_id(): BibleVersionBookStructure(BibleBook.LAMENTATIONS, 25, 5, {
        "1": 22, "2": 22, "3": 66, "4": 22, "5": 22
    }),
    BibleBook.EZEKIEL.get_id(): BibleVersionBookStructure(BibleBook.EZEKIEL, 26, 48, {
    ...
    BibleBook.DANIEL.get_id(): BibleVersionBookStructure(BibleBook.DANIEL, 27, 12, {
        "1": 21, "2": 49, "3": 30, "4": 37, "5": 31, "6": 28, "7": 28, "8": 27, "9": 27, "10": 21,
        "11": 45, "12": 13
    }),
    BibleBook.HOSEA.get_id(): BibleVersionBookStructure(BibleBook.HOSEA, 28, 14, {
        "1": 11, "2": 23, "3": 5, "4": 19, "5": 15, "6": 11, "7": 16, "8": 14, "9": 17, "10": 15,
        "11": 11, "12": 14, "13": 16, "14": 9
    }),
    BibleBook.JOEL.get_id(): BibleVersionBookStructure(BibleBook.JOEL, 29, 3, {
        "1": 20, "2": 32, "3": 21
    }),
    BibleBook.AMOS.get_id(): BibleVersionBookStructure(BibleBook.AMOS, 30, 9, {
        "1": 15, "2": 16, "3": 15, "4": 13, "5": 27, "6": 14, "7": 17, "8": 14, "9": 15
    }),
    BibleBook.OBADIAH.get_id(): BibleVersionBookStructure(BibleBook.OBADIAH, 31, 1, {
        "1": 21
    }),
    BibleBook.JONAH.get_id(): BibleVersionBookStructure(BibleBook.JONAH, 32, 4, {
        "1": 17, "2": 10, "3": 10, "4": 11
    }),
    BibleBook.MICAH.get_id(): BibleVersionBookStructure(BibleBook.MICAH, 33, 7, {
        "1": 16, "2": 13, "3": 12, "4": 13, "5": 15, "6": 16, "7": 20
    }),
    BibleBook.NAHUM.get_id(): BibleVersionBookStructure(BibleBook.NAHUM, 34, 3, {
        "1": 15, "2": 13, "3": 19
    }),
    BibleBook.HABAKKUK.get_id(): BibleVersionBookStructure(BibleBook.HABAKKUK, 35, 3, {
        "1": 17, "2": 20, "3": 19
    }),
    BibleBook.ZEPHANIAH.get_id(): BibleVersionBookStructure(BibleBook.ZEPHANIAH, 36, 3, {
        "1": 18, "2": 15, "3": 20
    }),
    BibleBook.HAGGAI.get_id(): BibleVersionBookStructure(BibleBook.HAGGAI, 37, 2, {
        "1": 15, "2": 23
    }),
    BibleBook.ZECHARIAH.get_id(): BibleVersionBookStructure(BibleBook.ZECHARIAH, 38, 14, {
        "1": 21, "2": 13, "3": 10, "4": 14, "5": 11, "6": 15, "7": 14, "8": 23, "9": 17, "10": 12,
        "11": 17, "12": 14, "13": 9, "14": 21
    }),
    BibleBook.MALACHI.get_id(): BibleVersionBookStructure(BibleBook.MALACHI, 39, 4, {
        "1": 14, "2": 17, "3": 18, "4": 6
    }),

    BibleBook.MATTHEW.get_id(): BibleVersionBookStructure(BibleBook.MATTHEW, 40, 28, {
    ...
    BibleBook.MARK.get_id(): BibleVersionBookStructure(BibleBook.MARK, 41, 16, {
        "1": 45, "2": 28, "3": 35, "4": 41, "5": 43, "6": 56, "7": 37, "8": 38, "9": 50, "10": 52,
        "11": 33, "12": 44, "13": 37, "14": 72, "15": 47, "16": 20
    }),
    BibleBook.LUKE.get_id(): BibleVersionBookStructure(BibleBook.LUKE, 42, 24, {
    ...
    BibleBook.JOHN.get_id(): BibleVersionBookStructure(BibleBook.JOHN, 43, 21, {
        "1": 51, "2": 25, "3": 36, "4": 54, "5": 47, "6": 71, "7": 53, "8": 59, "9": 41, "10": 42,
        "11": 57, "12": 50, "13": 38, "14": 31, "15": 27, "16": 33, "17": 26, "18": 40, "19": 42, "20": 31,
        "21": 25
    }),
    BibleBook.ACTS.get_id(): BibleVersionBookStructure(BibleBook.ACTS, 44, 28, {
    ...
    BibleBook.ROMANS.get_id(): BibleVersionBookStructure(BibleBook.ROMANS, 45, 16, {
        "1": 32, "2": 29, "3": 31, "4": 25, "5": 21, "6": 23, "7": 25, "8": 39, "9": 33, "10": 21,
        "11": 36, "12": 21, "13": 14, "14": 23, "15": 33, "16": 27
    }),
    BibleBook.FIRST_CORINTHIANS.get_id(): BibleVersionBookStructure(BibleBook.FIRST_CORINTHIANS, 46, 16, {
        "1": 31, "2": 16, "3": 23, "4": 21, "5": 13, "6": 20, "7": 40, "8": 13, "9": 27, "10": 33,
        "11": 34, "12": 31, "13": 13, "14": 40, "15": 58, "16": 24
    }),
    BibleBook.SECOND_CORINTHIANS.get_id(): BibleVersionBookStructure(BibleBook.SECOND_CORINTHIANS, 47, 13, {
        "1": 24, "2": 17, "3": 18, "4": 18, "5": 21, "6": 18, "7": 16, "8": 24, "9": 15, "10": 18,
        "11": 33, "12": 21, "13": 14
    }),
    BibleBook.GALATIANS.get_id(): BibleVersionBookStructure(BibleBook.GALATIANS, 48, 6, {
        "1": 24, "2": 21, "3": 29, "4": 31, "5": 26, "6": 18
    }),
    BibleBook.EPHESIANS.get_id(): BibleVersionBookStructure(BibleBook.EPHESIANS, 49, 6, {
        "1": 23, "2": 22, "3": 21, "4": 32, "5": 33, "6": 24
    }),
    BibleBook.PHILIPPIANS.get_id(): BibleVersionBookStructure(BibleBook.PHILIPPIANS, 50, 4, {
        "1": 30, "2": 30, "3": 21, "4": 23
    }),
    BibleBook.COLOSSIANS.get_id(): BibleVersionBookStructure(BibleBook.COLOSSIANS, 51, 4, {
        "1": 29, "2": 23, "3": 25, "4": 18
    }),
    BibleBook.FIRST_THESSALONIANS.get_id(): BibleVersionBookStructure(BibleBook.FIRST_THESSALONIANS, 52, 5, {
        "1": 10, "2": 20, "3": 13, "4": 18, "5": 28
    }),
    BibleBook.SECOND_THESSALONIANS.get_id(): BibleVersionBookStructure(BibleBook.SECOND_THESSALONIANS, 53, 3, {
        "1": 12, "2": 17, "3": 18
    }),
    BibleBook.FIRST_TIMOTHY.get_id(): BibleVersionBookStructure(BibleBook.FIRST_TIMOTHY, 54, 6, {
        "1": 20, "2": 15, "3": 16, "4": 16, "5": 25, "6": 21
    }),
    BibleBook.SECOND_TIMOTHY.get_id(): BibleVersionBookStructure(BibleBook.SECOND_TIMOTHY, 55, 4, {
        "1": 18, "2": 26, "3": 17, "4": 22
    }),
    BibleBook.TITUS.get_id(): BibleVersionBookStructure(BibleBook.TITUS, 56, 3, {
        "1": 16, "2": 15, "3": 15
    }),
    BibleBook.PHILEMON.get_id(): BibleVersionBookStructure(BibleBook.PHILEMON, 57, 1, {
        "1": 25
    }),
    BibleBook.HEBREWS.get_id(): BibleVersionBookStructure(BibleBook.HEBREWS, 58, 13, {
        "1": 14, "2": 18, "3": 19, "4": 16, "5": 14, "6": 20, "7": 28, "8": 13, "9": 28, "10": 39,
        "11": 40, "12": 29, "13": 25
    }),
    BibleBook.JAMES.get_id(): BibleVersionBookStructure(BibleBook.JAMES, 59, 5, {
        "1": 27, "2": 26, "3": 18, "4": 17, "5": 20
    }),
    BibleBook.FIRST_PETER.get_id(): BibleVersionBookStructure(BibleBook.FIRST_PETER, 60, 5, {
        "1": 25, "2": 25, "3": 22, "4": 19, "5": 14
    }),
    BibleBook.SECOND_PETER.get_id(): BibleVersionBookStructure(BibleBook.SECOND_PETER, 61, 3, {
        "1": 21, "2": 22, "3": 18
    }),
    BibleBook.FIRST_JOHN.get_id(): BibleVersionBookStructure(BibleBook.FIRST_JOHN, 62, 5, {
        "1": 10, "2": 29, "3": 24, "4": 21, "5": 21
    }),
    BibleBook.SECOND_JOHN.get_id(): BibleVersionBookStructure(BibleBook.SECOND_JOHN, 63, 1, {
        "1": 13
    }),
    BibleBook.THIRD_JOHN.get_id(): BibleVersionBookStructure(BibleBook.THIRD_JOHN, 64, 1, {
        "1": 14
    }),
    BibleBook.JUDE.get_id(): BibleVersionBookStructure(BibleBook.JUDE, 65, 1, {
        "1": 25
    }),
    BibleBook.REVELATION.get_id(): BibleVersionBookStructure(BibleBook.REVELATION, 66, 22, {
